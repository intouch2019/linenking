...
$objPHPExcel->getActiveSheet()->setCellValue('E1', 'Total Qty (MRP 1051-2625)');
$objPHPExcel->getActiveSheet()->setCellValue('F1', 'Total Value (MRP 1051-2625)');    
$objPHPExcel->getActiveSheet()->setCellValue('G1', 'Total Qty (MRP >2625)');
$objPHPExcel->getActiveSheet()->setCellValue('H1', 'Total Value (MRP >2625)');
...
if (!empty($alldealersobj) && isset($alldealersobj)) {
    foreach ($alldealersobj as $obj) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $rowCount, $obj->qty_1051_2625);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $rowCount, $obj->val_1051_2625);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $rowCount, $obj->qty_above_2625);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $rowCount, $obj->val_above_2625);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $rowCount, round($obj->val_1051_2625 - (($obj->val_1051_2625/1.12)*1.05)));
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $rowCount, round($obj->val_above_2625 - (($obj->val_above_2625/1.12)*1.18)));

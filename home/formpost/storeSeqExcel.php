...
try{
    ...
    //$objs = $db->fetchObjectArray($query);
     ...
     while($obj=$objs->fetch_object()){    
         ...
         if(trim($obj->sequence)!=""){
          $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $rowCount, $obj->sequence);        
         }
         $rowCount++;
     }   
...
header('Content-Disposition: attachment;filename="Store_Sequence.xls"');

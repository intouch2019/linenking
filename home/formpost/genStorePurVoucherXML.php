...
if($page){
    ...
    $query = " select i.* FROM it_sp_invoices i  WHERE  i.invoice_type = 0 and date(i.invoice_dt) >= $startdate  and date(i.invoice_dt) <= $enddate and store_id = $user->id order by id ";

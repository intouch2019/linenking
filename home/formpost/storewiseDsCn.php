...
$query="select * from it_creditnote_ds where cn_no=$cn_no";
...
$html .= "<table width=\"80%\" align=\"center\">";
    ...
    $totaltd=$obj->taxable_amt+$obj->sgst_paid+$obj->cgst_paid+$obj->igst_paid;
    ...
    $html .= "<tr><td colspan=2><span style=\"font-size:18px; padding:12px 0 0px 0\"><b>Remark:</b></span><br/>"
            . "<span style=\"font-size:14px; padding:12px 0 0px 0\">Discount Scheme:$obj->ds_remark</span><br/></td>"
            . "</tr>";
            //. "</table>";
...
$fname="../creditnote/DS_CN-$obj->cn_no.pdf";
$html2fpdf->writeHTML($html);
$html2fpdf->Output("../creditnote/DS_CN-$obj->cn_no.pdf", "F");

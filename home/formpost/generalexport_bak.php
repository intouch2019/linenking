...
$tfn = "accounts_".$storename."_".$date.".csv";
//$fname = "AuditLog/".$tfn;
$fname = $tfn;
$username = getCurrUser();

$objPHPExcel->getProperties()->setCreator($username->store_name)
                             ->setLastModifiedBy($username->store_name)

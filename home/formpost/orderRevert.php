...
if ($currStore->usertype != UserType::Dispatcher) { print "Unauthorized access"; return; }
...
else if ($obj->dispatcher_id != $store_id) { print "Order state can only be changed by by the Dispatcher who picked it up."; }
else {

...
<script language="javascript">
	...
	$(document).ready(function(){
		$('#arrival_date').datepicker({ inline: true, dateFormat: 'yy-mm-dd' });
		$('#stocked_date').datepicker({ inline: true, dateFormat: 'yy-mm-dd' });
<?php
...
<div id="shipmentDiv" style="display:none">
	<form method="post" action="postShipment.php">
		...
		<div class="clsText"><input type="text" id="arrival_date" name="arrival_date" readonly/></div>
		<div class="clsDiv">Supplies Stocked Date</div>
		<div class="clsText"><input type="text" id="stocked_date" name="stocked_date" readonly/></div>

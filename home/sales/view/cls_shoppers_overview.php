...
class cls_shoppers_overview extends cls_renderer {
...
loadChart("pie_gender","chartdata/shoppers/pie_gender.php?order=desc&field="+gFieldName+"&title=Gender","305","200");
loadChart("pie_married","chartdata/shoppers/pie_married.php?order=desc&field="+gFieldName+"&title=Marital Status","305","200");
loadChart("pie_occupation","chartdata/shoppers/pie_occupation.php?order=desc&field="+gFieldName+"&title=Occupation","305","200");
loadChart("pie_education","chartdata/shoppers/pie_education.php?order=desc&field="+gFieldName+"&title=Education","305","200");
loadChart("bar_agegroup","chartdata/shoppers/bar_agegroup.php?pg=overview","650","300");
}
...
Show <input type="radio" name="chartType" checked onclick="loadByOrders();">Number of Units</input>
<input type="radio" name="chartType" onclick="loadByRevenue();">By Value</input>
</form>
</div>
</div>
<div id="pie_gender"></div>
<div id="pie_married"></div>
<div id="pie_occupation"></div>
<div id="pie_education"></div>
<div id="msgbar" style="clear:both;height:40px;"></div>
<div id="bar_agegroup"></div>

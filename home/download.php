...
$user = getCurrUser();
if (!$user || ($user->usertype != UserType::Admin && $user->usertype != UserType::CKAdmin && $user->id!=100)) { print 'You have to be logged in to run this program. Login <a href="home/login">here</a>'; return; }

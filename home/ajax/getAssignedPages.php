...
try {
    ...
    $query=" select id, menuhead, pagename from it_pages where id in (select page_id from it_user_pages where user_id = $user_id) and sequence != -1 group by menuhead,pagename";
    //print $query;
//    error_log("\nPG QRY: $query\n",3,"tmp.txt");

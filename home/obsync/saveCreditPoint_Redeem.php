...
foreach ($arr as $record) {
	...
	$fields = explode("<>",$record);
        ...
        $update_query=" update it_store_redeem_points set is_reddeme =1,points_redeemdate =$redeem_date,invoice_no =$invoice_no where id=$server_id and store_id =$store_id";

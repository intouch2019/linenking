...
$expdt = "31122099";
$cmd = "/usr/bin/java -jar /var/www/html/linenking/crypt/IntouchLicense.jar $macaddress $expdt";
...
$cmd = "/usr/bin/java -jar /var/www/html/linenking/crypt/IntouchLicense.jar $license $userpass";
$access = exec($cmd);

          ...
          if(isset($stock_intransit_new) && trim($stock_intransit_new->intransit_stock_value_new) !="")
             {
               $intransit_stock_value_new = $stock_intransit_new->intransit_stock_value_new;
                ...
                else{ $intransit_stock_value_new = 0; }
                ...
                if(isset($store_stocklimit) && trim($store_stocklimit->min_stock_level) !=""){ $store_stocklimit_val = $store_stocklimit->min_stock_level; }else{ $store_stocklimit_val = 0; }

...
class cls_dispatch_droporder extends cls_renderer {
    ...
    function extraHeaders() {
        ...
        // When            the document is r            eady, initialize the link so
        // that when    it is clicked, the p            rintable area of the
        // page will pri    nt.
        function printOrder(pick            group_id) {
                        $.ajax({
                            type: "POST",
                    ...
                    <div style="margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; position: static; overflow-x: hidden; overflow-y: hidden; ">
                        <div class="block" id="accordion" style="margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; ">
                            <div id="accordion">
                                ...
                                <?php if ($this->currStore->id == $order->dispatcher_id && $order->status == OrderStatus::Shipped) { ?>
                            ...
                            <div class="box">
                                ...
                                <div class="block" id="<?php echo $divid; ?>">
                                    ...
                                    <div class="block grid_10" style="margin-top:30px;">
                                        ...
                                        <label style="font-weight: bold; margin-left:10px;">Quantity : </label> <?php print $qty1; ?>
                                        <label style="font-weight: bold; margin-left:10px;">Line : </label> <?php print $newdesign->lineno; ?>
                                        <label style="font-weight: bold; margin-left:10px;">Rack : </label> <?php print $newdesign->rackno;
                            ...
                            ?></h2>
                                <div class="block" id="<?php echo $divid; ?>">
                                    ...
                                    <div class="block grid_10" style="margin-top:30px;">
                                        <label style="font-weight: bold; margin-left:10px;">Style : </label> <?php print $newitem->style_name; ?>
                                        <label style="font-weight: bold; margin-left:10px;">Size : </label> <?php print $newitem->size_name; ?>
                                        <label style="font-weight: bold; margin-left:10px;">Quantity : </label> <?php print $qty2; ?>

...
class cls_store_orders_packing extends cls_renderer {
    var $currStore;
    var $params;
...
<div class="grid_10">
       ...
       //     $orders = $db->fetchObjectArray ("select o.*, c.store_name, u.store_name as dispatcher from it_ck_orders o, it_codes c, it_codes u where o.store_id = $store_id and o.store_id = c.id and o.status=".OrderStatus::Picking." and o.dispatcher_id = u.id order by o.active_time desc");
	    $orders = $db->fetchObjectArray("select p.*, o.pickgroup, o.status, max(o.active_time) as active_time, u.store_name as dispatcher, c.store_name from it_ck_orders o, it_ck_pickgroup p, it_codes c, it_codes u where o.store_id = $store_id and o.store_id = c.id and p.dispatcher_id = u.id and o.pickgroup = p.id and o.status = ".OrderStatus::Picking." group by o.pickgroup order by p.picking_time desc");

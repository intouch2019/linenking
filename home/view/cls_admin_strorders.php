...
class cls_admin_strorders extends cls_renderer {
    var $params;
    var $currStore;
...
//        alert(params);
        window.location.href = "formpost/loadStoreOrders.php?"+params;
    }
</script>    
<?php
    } // extraHeaders
...
<div class="grid_10">
    ...
    <div class="grid_5">
        <fieldset style="background-color:#b0b0b0;">
            <legend>Upload Store Orders</legend>
    <form id="loadstock" name="loadstock" enctype="multipart/form-data" method="post" action="formpost/checkOrderFile.php">

...
class cls_sincentive_multiplier extends cls_renderer {
...
$(function() {
     var url = "ajax/tb_incentive_m.php?ctgid=<?php echo $this->ctgid; ?>";
     //alert(url);
      oTable = $('#tb_incentive_m').dataTable({
                    "bProcessing": true,
                    "bServerSide": true,
            ...
            function ctgwise(ctg_id){
                ...
                window.location.href = "sincentive/multiplier/ctgid="+cat_id;
               }
            }
        ...
        <div class="grid_10">
            ...
            <div class="grid_5">
                <!--<fieldset class="login">-->
                    <legend>Set Incentive Multiplier</legend>
                    <form name="sIncentiveForm" id="sIncentiveForm" method="post" action="formpost/setIncentiveMultiplier.php">
                    <table>
<!--                        <tr>
...
//                                    }
                    ...
                    <tr>
                        <td colspan="5">Select MRP:</td>
                        <td colspan="5">
                            <select id="cmrp" name="cmrp[]" data-placeholder="Select MRP" style="width:100%" class="chzn-select" multiple > 
                            <?php if(isset($this->ctgid) && trim($this->ctgid)!="" && trim($this->ctgid)!=0){ ?>
                             <option value="-1">All</option>
                             <?php
                                $mrpquery = "select distinct mrp from it_items where ctg_id = $this->ctgid ";
                                $mrpobjs = $db->fetchObjectArray($mrpquery);
                                foreach($mrpobjs as $mrpobj){
                             ?>
                             <option value="<?php echo $mrpobj->mrp; ?>"><?php echo $mrpobj->mrp; ?></option>
                             <?php }} ?>
                    ...
                    <tr>
                        <td colspan="5">Enter Multiplier:</td>
                        <td colspan="5">
                            <input type="text" id="multiplier" name="multiplier" value="" style="width:100%">
                        </td>    
                    </tr>
                    <tr>
                        <td colspan="10">
                            <input type="submit" name="Submit" value="Set Incentive"></p>
                        </td>
                    </tr>
...
<!--                    <tr>
           ...
           <?php
            ...
            <legend>Incentive Multiplier Set Details</legend>		
            <table align="center" border="1" cellpadding="0" cellspacing="0" border="0" class="display" id="tb_incentive_m">
                <thead>
                    <tr>
                            <th>Category</th>
                            <th>MRP</th>

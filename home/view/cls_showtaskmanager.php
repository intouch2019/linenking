...
class cls_showtaskmanager extends cls_renderer {
...
//                                 if ($img->image) { ?>
                                                ...
                                                <!--<a href="<?php // echo $this->TaskImageUrl($img->image); ?>" rel="prettyPhoto"><img class="grid_3" align="right" src="<?php echo $this->TaskImageUrl($img->image); ?>" width="270" style="float: right;border: 1px solid #333; border-radius: 5px;"  /></a>-->
                            <?php // }} ?>
  ...
  .image-grid-item {
    ...
    margin: 10px;
                ...
                <p style="text-align: left;">
                 ...
                 <a href="reassigntaskmanager/ids=<?php echo $result->id ?>"> Reassign Task</a> 
                 </button>
                </p>

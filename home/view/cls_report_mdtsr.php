        ...
        <div class="grid_10">
            <div class="box">
                ...
                <?php if ($this->show_report): ?>
                    ...
                    . " AND p.amount not between 649 and 651 WHERE o.tickettype = 0 AND o.store_id IN ($store_id_str) AND o.bill_datetime BETWEEN '$from_dt' AND '$to_dt' GROUP BY o.id, o.tickettype ) AS bt ON bt.order_id = o.id "

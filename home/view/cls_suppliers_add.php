...
class cls_suppliers_add extends cls_renderer {
    var $currUser;
    var $userid;
...
<div class="grid_10">
    ...
    <div class="grid_5">
        <fieldset>
            ...
            <form action="formpost/addSupplier.php" method="post">
                <p>
                ...
                <p>
                    ...
                    <input type="text" name="contactPerson" value="<?php echo $this->getFieldValue('contactPerson'); ?>">
                </p>
                <p>
                    <label>Address: </label>
                    <input type="text" name="address" value="<?php echo $this->getFieldValue('address'); ?>">
                </p>
                <p>
                    <label>Email: </label>
                ...
                <p>
                    <label>Phone: </label>
                    <input type="text" name="phone" value="<?php echo $this->getFieldValue('phone'); ?>">
                </p>
                <p>
                    <label>VatNo: </label>
                    <input type="text" name="vatno" value="<?php echo $this->getFieldValue('vatno'); ?>">
                </p>
                        <?php if ($formResult) { ?>
                <p>

...
class cls_orders_cancelled extends cls_renderer {
    var $currStore;
    var $params;
...
<div class="grid_10">
            ...
            $orders = $db->fetchObjectArray ("select o.*, c.store_name from it_ck_orders o, it_codes c where o.store_id = c.id and o.status=".OrderStatus::Cancelled." order by o.active_time desc");

            ?>
    <div class="box">
        <h2>
            <a href="#" id="toggle-accordion" style="cursor: pointer; ">Cancelled Orders</a>
        </h2><br>

...
//                        if ($field=="loyalty") {$tableheaders.="Loyalty Points:"; $queryfields .= " sum(o.use_lpoints) as loyalty , "; $total_td .= "<td></td>";}
                        ...
                        if ($field=="area") {$tableheaders.="Area:"; $queryfields .= "c.Area,";$group_by[] = "c.Area"; $total_td .= "<td></td>";}
                        if ($field=="city") {$tableheaders.="City:"; $queryfields .= "c.city,";$group_by[] = "c.city"; $total_td .= "<td></td>";}
                        if ($field=="location") {$tableheaders.="Location:"; $queryfields .= "c.Location,";$group_by[] = "c.Location"; $total_td .= "<td></td>";}

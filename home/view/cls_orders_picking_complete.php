...
class cls_orders_picking_complete extends cls_renderer {
    var $currStore;
    var $params;
...
<div class="grid_10">
            ...
            if($this->currStore->usertype == UserType::Dealer){
                $sclause = " and o.store_id = ".$store_id;
            }

	    $orders = $db->fetchObjectArray("select p.*, max(o.active_time) as active_time, u.store_name as dispatcher, c.store_name from it_ck_orders o, it_ck_pickgroup p, it_codes c, it_codes u where o.store_id = c.id $sclause and p.dispatcher_id = u.id and o.pickgroup = p.id and o.status = ".OrderStatus::Picking_Complete."  group by o.pickgroup order by p.pickingComplete_time desc");
            ...
            <div class="block" id="accordion" style="margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; ">
			    ...
			    ?>
                        <tr>
                            ...
                            <td><?php echo mmddyy($order->pickingComplete_time); ?></td>

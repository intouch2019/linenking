...
//                 document.getElementById('salesincentive').style.display = 'none';
    ...
    function insertinc(){  // Function For Inserting Salesman And Store Incentive From Sales Login
        ...
        if(sman!="" && sincentive!="" && storeids!=null && from!="" && to!="" && atypes!='d' && yrtypes!='fd'  ){
                window.location.href="formpost/salesRepresentiveIncentive.php?storeids="+storeids+"&from="+from+"&to="+to+"&user_id="+user_id+"&sman="+sman+"&sincentive="+sincentive;
            }else{
...
//                    }
             ...
             //alert(enddate);  
               ...
               var ajaxURL = "ajax/incentinformation.php?storeid="+storeid+"&fromdate="+fromdate+"&enddate="+enddate;
                ...
                // alert('Please Select Year And Quarter');
                    ...
                    else if(qtr=='d' && yr=='fd'){    alert('Please Select Year And Quarter First');
                     window.location.reload();
                    } 
            }
        }
        ...
        function genRepExcel(){
           ...
           // alert(storeids);
            ...
            if(atypes!='d' && yrtypes!='fd'){
                //alert('hii');
                window.location.href="formpost/genSalesAndStoreIncentive.php?storeids="+storeids+"&dtrange="+dtrange+"&atypes="+atypes+"&yrtypes="+yrtypes;
            }else{
...
//            }
 ...
 <div class="grid_10">
            ...
            <div class="grid_17" >
              <fieldset class="login">
                ...
                foreach ($atypes as $avalue => $yrtype) {
                        $selected="";
                        if ($avalue == $form_atype) { $selected = "selected"; }
                ?>
    ...
    else if ( $this->currUser->usertype == UserType::CKAdmin ){?>
...
<div class="grid_10">
	...
	<fieldset class="login">	
            ...
            <?php
               if(trim($this->storeids=="-1")){ $str="selected";}else{ $str="";}
            ?>
            ...
            foreach ($atypes as $avalue => $atype1) {
                    $selected="";
                    if ($avalue ==$this->qtrtypess) { $selected = "selected"; }
            ?>
            ...
            <div>
            </br> <input size="17" type="hidden" id="dateselect" name="dateselect" value="<?php if (isset($this->dtrange)) { echo $this->dtrange;  } ?> " />
            </div>
            </div>  

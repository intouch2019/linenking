...
class cls_store_designs_otherctg extends cls_renderer {
    ...
    function extraHeaders() {
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("input:checkbox[name=brand]").click(function () {
                    ...
                    if (len == 1) {
                        var brand = array[0];
                        window.location.href = "store/designs/otherctg/brand=" + brand + "/ctg=<?php echo $this->ctg; ?>";
                    } else {
                        window.location.href = "store/designs/otherctg/ctg=<?php echo $this->ctg; ?>";
                    }
                });
                //--><!]]>
                //sidebar
        ...
        //            alert(num);
            ...
            function setMRP(dropdown)
            {
                ...
                window.location.href = "store/designs/otherctg/brand=<?php echo $this->brand; ?>/ctg=<?php echo $this->ctg; ?>/mrp=" + value;
            }
        ...
        //                alert(value);
                if (value != "0") {
                    window.location.href = "store/designs/otherctg/ctg=" + value;
                }
            }
        ...
        //        console.log(mrp);
                ...
                window.location.href = "store/designs/otherctg/brand=<?php echo $this->brand; ?>/ctg=<?php echo $this->ctg; ?>/size=" + value + mrpclause;
            }

            function search()
            {
                var des_code = document.getElementById("srch").value;
                var ajaxUrl = "ajax/getDesign_othrectg.php?ctg_id=<?php echo $this->ctg; ?>"
...
//                            </script>";
           ...
           <!--<select  name ="setotherccat" id = "setotherccat" style="width:160px" onchange="setMRP(this);">-->
                ...
                <select name="category"   single style="width:auto;" onchange="setCategory(this);">
                    <option value=0 selected="selected">Select Category</option>
                    <?php
                    $form_value = $this->getFieldValue('category');
                    //$objs = $db->fetchObjectArray("select * from it_categories where  id in(35,40,41,34,38,43,39,45)");
                    $objs = $db->fetchObjectArray("select * from it_categories where  setotheractive=1 and active=1 order by name ");

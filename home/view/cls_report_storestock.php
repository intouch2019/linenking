...
class cls_report_storestock extends cls_renderer{
...
<div class="grid_10">
	...
	<legend>Generate Stock Report</legend>
...
<?php } ?>
		...
		<div class="grid_8">
                    <label4>Date range:</label4>
                    <label for="from">From</label>
                    <input type="text" size="10" id="from" name="from" class="datepick" value="<?php echo $this->minDate; ?>" />
                    <label for="to">to</label>
                    <input type="text" size="10" id="to" name="to" class="datepick" value="<?php echo $this->maxDate; ?>" /> <span class="help"></span>
...
//            echo $query; //and c.id in ( $storeClause)
            ...
            $query2 = "select DATE_FORMAT(o.bill_datetime,'%d/%m/%Y') as bill_datetime,o.bill_no,o.tickettype,o.quantity,o.amount,o.tax,o.discount_val,o.discount_pct,o.voucher_amt from it_orders o where o.store_id in ( $storeClause ) $dQuery group by o.bill_no order by bill_datetime";
//            echo $query2;

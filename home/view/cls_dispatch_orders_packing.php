...
class cls_dispatch_orders_packing extends cls_renderer {
    var $currStore;
    var $params;
...
//	    $orders = $db->fetchObjectArray("select p.id, p.order_nos, p.order_nos as order_no, o.pickgroup, p.order_qty, p.order_amount, p.num_designs, o.status, max(o.active_time) as active_time, max(o.printing_time) as printing_time, o.picking_time, u.store_name as dispatcher, c.store_name from it_ck_orders o, it_ck_pickgroup p, it_codes c, it_codes u where o.store_id = c.id and o.dispatcher_id = u.id and o.pickgroup = p.id and o.status = ".OrderStatus::Picking." group by o.pickgroup order by o.picking_time desc");
...
//            print "select p.*, max(o.active_time) as active_time, u.store_name as dispatcher, c.store_name from it_ck_orders o, it_ck_pickgroup p, it_codes c, it_codes u where o.store_id = c.id and p.dispatcher_id = u.id and o.pickgroup = p.id and o.status = ".OrderStatus::Picking." group by o.pickgroup order by p.picking_time desc";
            ?>
    <div class="box">
        <h2>

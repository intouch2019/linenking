...
try {
    ...
    $alldealersobj = $db->fetchObjectArray("select id,store_name from it_codes where usertype = " . UserType::Dealer . " and is_closed = 0 and id not in (70,147) order by id "); //and inactive = 0
